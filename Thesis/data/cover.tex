...
\newcommand{\miji}{}%密级
                    ...
                    % 秘密$\bigstar$5年
\newcommand{\UDC}{}%UDC
\newcommand{\oucctitle}{基于Docker的WEB平台开发以及系统优化策略研究}%论文中文题目
\ctitle{基于Docker的WEB平台开发以及系统优化策略研究}%必须修改因为页眉中用到
...
\newcommand{\oucetitle}{Research on Web Platform Development Based on Docker and System Optimization Strategy}%论文英文题目
...
\vskip12bp
{\xiaosi\heiti\noindent
关键词：\hskip1em JAVA, FDP, Docker, WEB系统优化, 负载均衡}
